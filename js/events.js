...
const allControlsForSave = [
    gridSizeSlider, zoomSlider, fadeSlider, finishPositionSlider, berryCountSlider, minDistanceSlider, maxDistanceSlider, rainbowBorderSlider, 
    showPathCheckbox, toggleHead, toggleBerries, toggleTail, toggleRainbowBorder, formatWebmRadio, formatMp4Radio, applyPathBtn, 
    toggleVolumeEffectBg, volumeStyleSelectBg, volumeIntensitySliderBg,
    toggleVolumeEffectCover, volumeStyleSelectCover, volumeIntensitySliderCover
];
allControlsForSave.forEach(control => {
